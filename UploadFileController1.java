...
public class UploadFileController1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet UploadFileController1</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet UploadFileController1 at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
//File myTestFile= new File(Api.CONTEXT_PATH+"priya");
...
//System.out.println(path);
                    ...
                    else
                {
                    ...
                    if (row > 0) 
                    {
                        out.println("File Level Verified successfully!!!");
...
//System.out.println(path);
                    ...
                    RequestDispatcher rs = request.getRequestDispatcher("Block.jsp");
                    rs.include(request, response);
